...
pub const SignatureHelpProvider = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) SignatureHelpProvider {
    ...
    pub fn getSignatureHelp(
        ...
        const signature = try self.buildSignature(func_name.?, text);
    ...
    fn buildSignature(self: *SignatureHelpProvider, func_name: []const u8, text: []const u8) !SignatureInformation {
        _ = text;
